---
title: "Relevant  Writeup - Try-Hack-Me"
date: 2024-02-25
categories: [Writeups, Try-Hack-Me]
tags: [Windows, Medium]
image: 
  path: assets/img/imagenes/Relevant.jpeg
...
![img](/assets/img/imagenes/Pasted image 20240223205759.png)

### Enumeracion del puerto 445

![img](/assets/img/imagenes/Pasted image 20240223215640.png)
...
![img](/assets/img/imagenes/Pasted image 20240223220300.png)
...
![img](/assets/img/imagenes/Pasted image 20240223222058.png)
...
![img](/assets/img/imagenes/Pasted image 20240223232625.png)

### ReverseShell
creamos una reverse shell con msfvenom. la subimos al directorio compartido y luego hacemos la conexión 
![img](/assets/img/imagenes/Pasted image 20240223234147.png)

### Escalada de privilegios

![img](/assets/img/imagenes/Pasted image 20240223234543.png)
###### realizando una busqueda por google
![img](/assets/img/imagenes/Pasted image 20240223235231.png)


###### conseguimos uno que ya esta compilado 
![img](/assets/img/imagenes/Pasted image 20240223235737.png)

###### subimos el archivo al directorio compartido
![img](/assets/img/imagenes/Pasted image 20240223235833.png)

###### para buscar el archivo lo hacemos con el siguiente comando 
```python
	dir NombreDelArchivo /s /p
```
![img](/assets/img/imagenes/Pasted image 20240224000305.png)

###### ejecutamos el exploit 
![img](/assets/img/imagenes/Pasted image 20240224000736.png)
