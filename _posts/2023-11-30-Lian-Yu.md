---
title: "Lian-Yu Writeup - Try-Hack-Me"
date: 2023-11-30
categories: [Writeups, Try-Hack-Me]
tags: [Linux, Easy]
image: 
  path: assets\img\imagenes\Lian-Yu.jpeg
...
![img](/assets/img/imagenes/Pasted image 20231202223932.png)
no parece haber mucha cosa en la pagina web y el codigo fuente parece estar bien.

### Fuzzing con wfuzz
![img](/assets/img/imagenes/Pasted image 20231202225935.png)

subdominio /island
![img](/assets/img/imagenes/Pasted image 20231202225848.png)

subdominio /island/2100
![img](/assets/img/imagenes/Pasted image 20231202230524.png)

### codigo fuente del subdominio /island/2100
![img](/assets/img/imagenes/Pasted image 20231202230745.png)
tenemos un mensaje que nos deja saber que tenemos una pista que lleva como agregado .ticket

### Fuzzing con wfuzz
![img](/assets/img/imagenes/Pasted image 20231202234008.png)
...
![img](/assets/img/imagenes/Pasted image 20231202234220.png)
...
![img](/assets/img/imagenes/Pasted image 20231203014822.png)

### ya tenemos credenciales asi que intentaremos entrar por ssh
![img](/assets/img/imagenes/Pasted image 20231203015004.png)

### Podemos ejecutar pkexec como root asi que esto sera facil para escalar privilegios
![img](/assets/img/imagenes/Pasted image 20231203015735.png)
